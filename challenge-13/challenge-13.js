...
chamada `newSudeste`.
*/
var newSudeste = brasil.splice( 5, 4 ); /*a partir do quinto índice, removerei 4.
caso queira remover todos de determinado índice até o final, só preciso informar
o índice de início: */
var newSudeste = brasil.splice( 5 ); //cuidado para não rodar o código dias vezes. Escolha um
