...
//indica quem será o this da função, já que o this em use strict é undefined
  ...
  */
  function sum() {
  	...
  	return Array.prototype.reduce.call(arguments,
  		...
  		return +accumulated + +actualItem; //operador + como unário converte em número.
      //opç2: return (+accumulated) + (+actualItem);
      //opç3: return Number(accumulated) + Number(actualItem);
  	}) ; 
  }
