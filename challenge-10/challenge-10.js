...
*/
//var five = '5'; variável como string

var five = Number ('5'); //variável convertida.
console.log( five + ' é número?', typeof five === 'number' );

//var concat = 10 + 10; variável como number
...
function isOperatorValid(operator){
		...
		return !!operation[operator]; //Operador é válido? (usando equivalente booleano)
